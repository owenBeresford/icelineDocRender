...
* and I added a better cache builder in JS; which runs faster than the old one.  The new one can be run from the CLI, and thus I can conmpile the entire site.
